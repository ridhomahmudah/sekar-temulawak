    ...
    <section class="px-36 pt-24 relative">
      <div class="shadow-xl sm:rounded-lg">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr 
              v-for="produk in cartStore.produkList" 
              ...
              <td class="w-4 p-4">
                <div class="flex items-center">
                  <input 
                    type="checkbox" 
                    @change="toggleSelectProduct(produk.id_produk)" 
              ...
              <td class="px-6 py-4">
                <form class="w-max">
                  <div class="relative flex items-center max-w-[8rem]">
                    ...
                    <input 
                      type="text" 
                      v-model.number="produk.jumlah" 
                      @change="updateQuantity(produk, produk.jumlah)" 
                      class="bg-gray-50 border-x-0 border-gray-300 h-11 text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full py-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      placeholder="999" 
                      required />
                    <button 
                      type="button" 
                      @click="increment(produk)"
