<nav class="bg-gray-100" x-data="{ isOpen: false }">
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    <div class="hidden px-5 md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <x-admin_navlink href="{{ url('/admin-produk') }}"
                                :active="request()->is('admin-produk')">Produk</x-admin_navlink>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            ...
            <x-admin_navlink_mobile href="{{ url('/admin-home') }}" :active="request()->is('admin-home')">Dashboard</x-admin_navlink_mobile>
            <x-admin_navlink_mobile href="{{ url('/admin-konten') }}" :active="request()->is('admin-konten') ||
                request()->is('ubah-artikel') ||
