<nav class="bg-gray-100" x-data="{ isOpen: false }">
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    <div class="hidden px-5 md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <x-admin_navlink href="{{ url('/admin-home') }}"
                                :active="request()->is('admin-home')">Dashboard</x-admin_navlink>
                            <x-admin_navlink href="{{ url('/admin-konten') }}" :active="request()->is('admin-konten') ||
                                request()->is('ubah-artikel') ||
                                request()->is('tambah-artikel')">Blog</x-admin_navlink>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            ...
            <x-admin_navlink href="{{ url('/admin-home') }}" :active="request()->is('admin-home')">Dashboard</x-admin_navlink>
            <x-admin_navlink href="{{ url('/admin-konten') }}" :active="request()->is('admin-konten') ||
                request()->is('ubah-artikel') ||
                request()->is('tambah-artikel')">Blog</x-admin_navlink>
            <x-admin_navlink href="{{ url('/admin-produk') }}" :active="request()->is('admin-produk') ||
                request()->is('tambah-produk') ||
                request()->is('ubah-produk') ||
                request()->is('admin-detail-produk')">Produk</x-admin_navlink>
            <x-admin_navlink href="{{ url('/admin-pesanan') }}" :active="request()->is('admin-pesanan') || request()->is('detail-pesanan')">Pesanan</x-admin_navlink>
            <x-admin_navlink href="{{ url('/admin-tentang') }}" :active="request()->is('admin-tentang') || request()->is('admin-landingpage')">Tentang</x-admin_navlink>
        ...
        <div class="border-t border-green-500 pb-3 pt-4">
            ...
            <div class="mt-3 space-y-1 px-2">
                ...
                <a href="#"
                    class="block rounded-md px-3 py-2 text-base font-medium text-gray-500 hover:bg-green-500 hover:text-white">Sign
                    out</a>
            </div>
        </div>
    </div>
